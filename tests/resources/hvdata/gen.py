...
# to a file
def generate_to_file(n, m, seed, plow, phigh, rlow, rhigh, filename):
    np.random.seed(seed)
    points = generate_ndpoints(n, m, plow, phigh)
    refp = generate_refp(m, rlow, rhigh)
    hv = get_hv(points, refp)
    ...
    for n in ns:
        for (m, phigh) in zip(ms, phighs):
            ...
            for seed in range(10):
                ...
                generate_to_file(n, m, seed, plow, phigh, rlow, rhigh, fname)
